 ...
 * @since 07.06.16
 */
public abstract class BaseRecyclerAdapter<DATA, VIEW extends View & DataEntity<DATA, VIEW>> extends RecyclerView.Adapter<BaseRecyclerAdapter.ViewHolder<DATA, VIEW>> {

    protected static class ViewHolder<DATA, VIEW extends View & DataEntity<DATA, VIEW>> extends RecyclerView.ViewHolder {
        ...
        public final void setData(@Nullable DATA data, @NonNull Object... objects) {
